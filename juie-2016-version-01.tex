...
of Tweets using Support Vector Machines}
...
The dataset for the problem at hand is composed of a set of tweets for 4 different languages - English, Dutch, Italian, and Spanish. It was decided to build one model for age classification and another model for gender classification. There were 4 categories for the age classification - 18-24, 25-34, 35-49, and 50 and above but for Dutch and Italian, age classification is not possible because there was no data given.
...
Looking at English tweets, the table~\ref{table:TweetStats} gives the characteristics of this particular section of the dataset.
